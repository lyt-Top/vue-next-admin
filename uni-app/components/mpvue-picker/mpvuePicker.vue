        ...
        methods: {
            initPicker(valueArray) {
                ...
                if (this.mode === 'selector') {
                    ...
                    this.pickerValueHour = years;
                    this.pickerValueMinute = months;
					this.pickerValueMulThreeThree = days;
            ...
            _getPickerLabelAndValue(value, mode) {
                ...
                if (mode === 'selector') {
                    ...
                    pickerLable = `${this.pickerValueHour[value[0]].label}${this.pickerValueMinute[value[1]].label}${this.pickerValueMulThreeThree[value[2]].label}`;
                    pickerGetValue.push(this.pickerValueHour[value[0]].value);
                    pickerGetValue.push(this.pickerValueHour[value[1]].value);
                    pickerGetValue.push(this.pickerValueHour[value[2]].value);
